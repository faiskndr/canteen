        ...
        <div class="w-full max-w-2xl mx-auto">
            <div class="bg-white border-4 border-gray-800 p-8">
              <h1 class="text-3xl font-bold mb-2">
                {{$isEdit ? 'EDIT KANTIN' : 'TAMBAH KANTIN'}}
              </h1>
              <p class="text-gray-600 mb-6">Isi data kantin</p>
      ...
      <div class="w-full max-w-6xl mx-auto">
        <div class="bg-white border-4 border-gray-800 p-8 mb-6">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h1 class="text-3xl font-bold">MANAJEMEN KANTIN</h1>
              <p class="text-gray-600">Total: {{$total}} kantin</p>
            </div>
        ...
        <div class="space-y-4">
            @forelse($kantin as $k)
                <div key={s.id} class="bg-white border-4 border-gray-800 p-6">
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                      <h3 class="font-bold text-xl">{{ $k->nama }}</h3>
                    </div>
                    <div class="flex gap-2">
                        <button
                            wire:click="open({{ $k->kantin_id }} )"
            ...
            @empty
                <div class="bg-white border-4 border-gray-800 p-12 text-center">
                    <p class="text-gray-500 font-bold">KANTIN TIDAK DITEMUKAN</p>
                </div>
            @endforelse
        </div>
      </div>
